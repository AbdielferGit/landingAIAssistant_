...
Toutes les URL sont mesurables et mènent au formulaire de demande de rendez-vous.

## FR01 — Reel · Découverte

**Texte à l’écran**

1. Votre équipe utilise déjà l’IA.
2. Mais chacun à sa façon.
3. Le vrai défi n’est pas l’outil.
4. C’est l’adoption.
5. Commencez par une priorité claire.
...
1. 5 signes que votre PME est prête pour un premier projet d’IA
2. Les rapports prennent trop de temps
3. Le suivi client dépend de notes dispersées
4. L’information est difficile à retrouver
5. Les tâches répétitives ralentissent l’équipe
6. Quelques personnes utilisent l’IA, sans cadre commun
7. Choisissez une seule priorité pour commencer
...
**Visuel :** « L’IA n’est pas un projet d’outil. C’est un projet d’adoption. »
...
**Script, 20–25 secondes**

« Prenons un rapport hebdomadaire. Avant : chercher les données, copier, reformater, résumer. Avec un flux d’IA bien conçu : l’information est préparée, l’équipe vérifie et le gestionnaire décide. Le but n’est pas de retirer le jugement humain. C’est de lui redonner du temps. »

**Texte final :** Quel processus mérite d’être repensé en premier ?
...
1. Une adoption de l’IA en 3 étapes
2. Explorer — repérer les frictions et prioriser
3. Activer — construire un cas réel et le mesurer
4. Déployer — former, documenter et gouverner
5. Une avancée utile, sans désorganiser les opérations
...
1. « Et nos données ? »
2. Bonne question.
3. Définir ce qui peut être utilisé
4. Choisir les outils autorisés
...
**Visuel :** « 30 minutes. Une priorité claire. »
...
1. Que recevez-vous pendant le diagnostic ?
2. Une friction opérationnelle clarifiée
3. Une première opportunité d’IA
4. Les risques et conditions à vérifier
5. Une prochaine étape concrète
6. Choisissez votre date préférée
